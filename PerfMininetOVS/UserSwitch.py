...
def myNetwork():
    ...
    s2 = net.addSwitch('s2', cls=UserSwitch, failMode='standalone')
    s3 = net.addSwitch('s3', cls=UserSwitch, failMode='standalone')
    s4 = net.addSwitch('s4', cls=UserSwitch)
    s5 = net.addSwitch('s5', cls=UserSwitch, failMode='standalone')
    s6 = net.addSwitch('s6', cls=UserSwitch, failMode='standalone')
    s7 = net.addSwitch('s7', cls=UserSwitch)
    s8 = net.addSwitch('s8', cls=UserSwitch, failMode='standalone')
    s9 = net.addSwitch('s9', cls=UserSwitch, failMode='standalone')
