...
def myNetwork():
    ...
    s2 = net.addSwitch('s2', cls=IVSSwitch, failMode='standalone')
    s3 = net.addSwitch('s3', cls=IVSSwitch, failMode='standalone')
    s4 = net.addSwitch('s4', cls=IVSSwitch)
    s5 = net.addSwitch('s5', cls=IVSSwitch, failMode='standalone')
    s6 = net.addSwitch('s6', cls=IVSSwitch, failMode='standalone')
    s7 = net.addSwitch('s7', cls=IVSSwitch)
    s8 = net.addSwitch('s8', cls=IVSSwitch, failMode='standalone')
    s9 = net.addSwitch('s9', cls=IVSSwitch, failMode='standalone')
